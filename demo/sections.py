...
def render_autonomous_section() -> str:
    return (
        ...
        '<svg viewBox="0 0 900 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;min-height:280px;font-family:Inter,system-ui,sans-serif;margin-top:10px;">'
        # --- animated defs ---
        '<defs>'
        '<marker id="arw" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#b08968"/></marker>'
        '<linearGradient id="nodeGrad" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#ffffff"/><stop offset="100%" stop-color="#f0ece4"/></linearGradient>'
        '<filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="4" flood-opacity="0.12"/></filter>'
        '</defs>'
        # --- flow arrows (animated dash) ---
        '<style>'
        '@keyframes flowDash{0%{stroke-dashoffset:12}100%{stroke-dashoffset:0}}'
        '.flow-arrow{stroke:#b08968;stroke-width:2.5;fill:none;marker-end:url(#arw);stroke-dasharray:6 6;animation:flowDash 0.8s linear infinite}'
        '.node-box{fill:url(#nodeGrad);stroke:#d1c9bd;stroke-width:2;rx:12;filter:url(#shadow)}'
        '.node-icon{font-size:28px;text-anchor:middle;dominant-baseline:central}'
        '.node-label{font-size:13px;fill:#1e293b;text-anchor:middle;font-weight:700}'
        ...
        '<text class="node-sub" x="390" y="208" style="font-size:11px;fill:#475569;font-weight:600;">← feedback loop: reward signal drives next observation →</text>'
        '</svg>'
        '</div>'
        '</section>'
    )
